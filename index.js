 ...
 */
export var getUnfinishedPurchases = function () { return Platform.select({
    ios: function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            checkNativeiOSAvailable();
            return [2 /*return*/, RNIapIos.getUnfinishedPurchases()];
        });
    }); },
...
var iapUtils = {
    ...
    getUnfinishedPurchases: getUnfinishedPurchases,
